...
**Base:** branched from `main` at `8bc9496`. WI-1 (#122) has since landed, and `origin/main` (`75723e7`) is merged in at `21190c0`. So the desktop mark, `--strict-markers`, the pinned-interpreter check and the window guard all apply to this branch.

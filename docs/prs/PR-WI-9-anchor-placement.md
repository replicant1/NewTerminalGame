...
```
terminal_game/shell/placement.py:1-22     -> docstring; OFFSET (C1)
terminal_game/shell/placement.py:24-50    -> Rect and its geometry (C2, C4)
terminal_game/shell/placement.py:53-63    -> display_for (C4)
terminal_game/shell/placement.py:66-86    -> _clamp_axis and clamp, whole points rounded inwards (C2)
terminal_game/shell/placement.py:89-103   -> place (C1, C2, C3, C4); the no-display ValueError (A1)
...
evidence/WI-9/terminal-anchor-396368b.json -> the C6 record (taken at 396368b, the code as it stands)

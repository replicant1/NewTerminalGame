...
| CTRL-5 | WI-9, WI-17, WI-18 | `tests/test_input_translator.py::EveryOtherKeyIsDiscarded`, `tests/test_input_translator.py::NothingIsEchoedAnywhere` and `tests/test_game.py::AKeyReachingTheSessionTest::test_an_unmapped_key_asks_the_session_for_nothing_at_all` | **Pinned** |
